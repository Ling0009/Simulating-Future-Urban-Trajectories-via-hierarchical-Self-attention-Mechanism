...
def read_raw_data(fpath = "./data/chengdushi_1101_1110_1000.csv", row_number=400000):
    #parameters
    keep_every = 20
    # 每格长度(m)
    xstep = 100
    ...
    df = pd.read_csv(fpath, nrows=row_number, names=['_', '__', 'POLYLINE']).drop_duplicates()  #(2140172, 3)
